...
public class MealsWithoutAllergens {
    private Set<String> allergensDictionary;
    private List<String[]> meals;

    public MealsWithoutAllergens(String filePath) {
    ...
    private void processCSV(String filePath) {
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // Store meals for filtering (include website info)
                meals.add(new String[]{website, name, ingredients, allergens});
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public List<String[]> getMealsWithoutAllergen(String allergen) {
        return meals.stream()
                .filter(meal -> meal[3] == null || !meal[3].contains(allergen))
